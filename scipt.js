...
const allThumbnail = Array.from(
  document.querySelectorAll(".w-thumbnail-primary")
);
const allThumbnailLightbox = Array.from(
  document.querySelectorAll(".w-thumbnail-lightbox")
);
...
const imgPrimaryLightboxWrapper = document.getElementById(
  "img-primary-lightbox-wrapper"
);
